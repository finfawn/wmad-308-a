  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 148, 5, 5)),
        ),
        home: MyHomePage(),
      ),
    );
...
class MyAppState extends ChangeNotifier {
  ...
  var aboutme = <WordPair>[WordPair('Jade Art', 'Joaquin')];  // Add the content here
        ...
        for (var pair in appState.aboutme)
          Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(
                'About Me Section by Joaquin, Jade Art A.',
