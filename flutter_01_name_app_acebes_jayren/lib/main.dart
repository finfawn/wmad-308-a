      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSeed(
              seedColor: const Color.fromARGB(255, 5, 19, 43)),
        ),
        home: MyHomePage(),
      ),
    );
...
class MyAppState extends ChangeNotifier {
  ...
  var dislikes = <WordPair>[]; // Dislike list
  ...
  Widget build(BuildContext context) {
    ...
    switch (selectedIndex) {
      ...
      case 2:
        ...
        break;
      case 3:
        page = AboutMePage(); // Added About Me page
        break;
      default:
              ...
              child: NavigationRail(
                ...
                destinations: [
                  ...
                  NavigationRailDestination(
                    ...
                    label: Text('Dislikes'), // Dislike option
                  ),
                  NavigationRailDestination(
                    icon: Icon(Icons.question_mark_sharp),
                    label: Text('About Me'), // About Me option
                  ),
                ],
...
class GeneratorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (appState.dislikes.contains(pair)) {
      dislikeIcon = Icons.thumb_down_alt;
    } else {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text(
                'Jayren Acebes', // Your name inside a "button-like" box
                style: Theme.of(context).textTheme.displayMedium?.copyWith(
                      color: Theme.of(context).colorScheme.onPrimary,
                    ), // Same style as home page text, just like a button
              ),
            ),
            SizedBox(height: 20),
            Text(
              'HELLO!!', // Your "HELLO!!" text
